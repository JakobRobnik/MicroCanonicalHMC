...
target = IllConditionedGaussian(
    d=100, condition_number=10**6, numpy_seed=None, prior="posterior"
)
...
bias = jnp.average(
    jnp.square(second_moments - target.second_moments[None, None, :])
    / target.variance_second_moments[None, None, :],
    axis=-1,
)
for i in range(10):
