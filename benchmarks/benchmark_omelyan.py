...
run_benchmarks(batch_size=4, models=models, key_index=20, do_grid_search=False, do_non_grid_search=True, do_fast_grid_search=False, return_ess_corr=False, integrators = ["omelyan", "mclachlan", "velocity_verlet"])
