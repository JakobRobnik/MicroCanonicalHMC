...
models = {model(d): {'mclmc': 20000, 'adjusted_mclmc': 20000, 'adjusted_mchmc': 20000, 'adjusted_hmc': 20000, 'nuts': 20000}
...
run_benchmarks(batch_size=128, models=models, key_index=20, do_grid_search=False, do_non_grid_search=True, do_fast_grid_search=False, return_ess_corr=False, integrators = ["omelyan", "mclachlan", "velocity_verlet"])
