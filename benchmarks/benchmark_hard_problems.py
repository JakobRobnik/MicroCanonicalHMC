...
run_benchmarks(batch_size=batch_size, models=models, key_index=26, do_grid_search=False, do_fast_grid_search=False, do_non_grid_search=True, integrators = ["mclachlan", "velocity_verlet"])
